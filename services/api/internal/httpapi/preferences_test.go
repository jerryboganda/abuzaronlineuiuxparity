...
func TestPreferenceRuntimeStatusOnlyClaimsProvenBehavior(t *testing.T) {
	for _, definition := range reviewedPreferenceRegistry() {
		...
		case "Report/Default Header On Report:",
			...
			"Point of Sale/Sale Sets/Deals In POS:",
			"Point of Sale/Auto Production In POS:",
			"Point of Sale/Ask Associate Sale Invoices on Saving:",
			"Point of Sale/Check Due Date on Saving:",
			"Point of Sale/Reset Inv. Balance Field in Footer On Saving",
			"Point of Sale/Default Cash Drawer COM Port",
			"General/Check Manual Backup Health At StartUp:",
			"General/Age of Item Changes For Data Carry (in Days):",
			"Adjustment/In Adj. Buffer, Pending Due Effect:",
			"General/In Sale/Return:",
			"General/In Basic Data:",
			"General/In Accounts Module:",
			"General/In Purchase/Purchase Return:",
			"General/In Purchase/Purchase Return Services:",
			"General/In Accounts:",
			"General/Enable Quick Search:",
			"General/Quick Search Type:",
			"Sale/Cash Sale Initial Focus:",
			"Sale/Credit Sale Initial Focus:",
			"Quotation/Allow Duplicate Items:",
			"General/Inventory System:",
			"General/Inventory Movement Method:",
			"General/Enable Alias Name:",
			"General/Search Item Code if Alias Name Not Found:",
			"General/Allow Login A User Multiple Times:",
			"General/Auto Responsive Search With Alternate Alias Name:",
			"Sale Return/Update Avg. Price:",
			"Sale Return/Allow Empty Sale Inv # in Unposted S/R Module:",
			"Purchase Return/Allow Empty Pur. Invoice No.:",
			"Purchase Return/Update Avg. Price On P/R:",
			"Purchase Return/Allow P/R Below Avg. Price:",
			"Adjustment/Update Avg. Price:",
			"Purchase Order/Auto Update Transit Stock at Posting:",
			"Purchase Order/Update Re-Order Qty at Saving:",
			"Purchase Order/Update Minimum Qty at Saving:",
			"Purchase Order/Update Optimum Qty at Saving:",
			"Point of Sale/Prompt For Zero Stock:",
			"Point of Sale/Lock Sale Qty/Bonus:",
			"Point of Sale/Lock Item Name:",
			"Point of Sale/Must Save Invoice on Exit:":
			continue
		default:
