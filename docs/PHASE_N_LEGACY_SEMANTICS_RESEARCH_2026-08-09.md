...
`docs/PHASE_N_REPORT_PROMOTION_2026-08-09.md`'s declined-candidates table and
...
`docs/PHASE_N_REPORT_PROMOTION_2026-08-09.md`'s "Candidates examined and
...
Per `docs/AGENT_HANDOFF.md` §2 ("Environment map"), the sandbox copy is the
...
framing in `docs/PHASE_N_REPORT_PROMOTION_2026-08-09.md` lines 167-168.**
...
database. `docs/PHASE_N_REPORT_PROMOTION_2026-08-09.md` line 169's decision
...
`docs/PHASE_N_GOLDEN_VERIFICATION_SUMMARY_2026-08-09.md`'s existing
