...
`docs/PHASE_N_O_GOLDEN_VERIFICATION_CORE_2026-08-09.md`: each leaf's own SQL
...
`sale-detail`, see `docs/PHASE_N_O_GOLDEN_VERIFICATION_CORE_2026-08-09.md`
...
- `docs/PHASE_N_GOLDEN_VERIFICATION_SALE_RETURN_2026-08-09.md` (this file)
