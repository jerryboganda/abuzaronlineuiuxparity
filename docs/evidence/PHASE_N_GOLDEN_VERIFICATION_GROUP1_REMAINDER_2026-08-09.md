...
already covered by `docs/evidence/PHASE_N_GOLDEN_VERIFICATION_SUMMARY_2026-08-09.md`'s sibling leaves.
...
`business_document_lines` sale detail in `docs/evidence/PHASE_N_GOLDEN_VERIFICATION_SUMMARY_2026-08-09.md`
...
in `docs/evidence/PHASE_N_GOLDEN_VERIFICATION_SUMMARY_2026-08-09.md` (#3/#17-19). This leaf is the
...
dimension in `docs/evidence/PHASE_N_GOLDEN_VERIFICATION_SUMMARY_2026-08-09.md`). The "invoice range
