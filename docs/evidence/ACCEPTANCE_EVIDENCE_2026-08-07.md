...
- The sales SalePrice selector now covers all ten captured tiers, preserves the
  ...
  [`docs/evidence/PHASE_G_PRICING_WORKFLOW_EVIDENCE_2026-08-07.md`](PHASE_G_PRICING_WORKFLOW_EVIDENCE_2026-08-07.md);
...
- The captured Stock in Hand > Back Date report now reads imported
  ...
  [`docs/evidence/PHASE_P_HISTORICAL_STOCK_BACK_DATE_EVIDENCE_2026-08-07.md`](PHASE_P_HISTORICAL_STOCK_BACK_DATE_EVIDENCE_2026-08-07.md).
- The four captured stock threshold leaves now use a distinct normalized
  ...
  [`docs/evidence/PHASE_P_STOCK_LEVEL_EVIDENCE_2026-08-07.md`](PHASE_P_STOCK_LEVEL_EVIDENCE_2026-08-07.md).
- `Item Stock Register Summary` now uses a normalized posted stock-ledger
  ...
  in [`docs/evidence/PHASE_P_ITEM_STOCK_SUMMARY_EVIDENCE_2026-08-07.md`](PHASE_P_ITEM_STOCK_SUMMARY_EVIDENCE_2026-08-07.md).
- `Stock and Sales` now joins normalized current balances to canonical posted
  ...
  grouping, source reconciliation, and print output remain open. Evidence is
  in [`docs/evidence/PHASE_P_STOCK_SALES_EVIDENCE_2026-08-07.md`](PHASE_P_STOCK_SALES_EVIDENCE_2026-08-07.md).
- The captured GL Journal alias now reads the imported `historical_gl_entries`
  ...
  open. Evidence is in
  [`docs/evidence/PHASE_K_HISTORICAL_GL_EVIDENCE_2026-08-07.md`](PHASE_K_HISTORICAL_GL_EVIDENCE_2026-08-07.md).
...
- `Deleted Sale Items Log` now has a retained `dbo.DeletedSaleItem` target,
  ...
  [`docs/evidence/PHASE_Q_DELETED_SALE_ITEMS_EVIDENCE_2026-08-07.md`](PHASE_Q_DELETED_SALE_ITEMS_EVIDENCE_2026-08-07.md).
...
- Four item-maintenance leaves now have canonical, tenant-scoped PostgreSQL
  ...
  `docs/evidence/PHASE_S_ITEM_MAINTENANCE_EVIDENCE_2026-08-07.md`; the remaining
...
- The imported group-scope setting leaves now read and update only their
  ...
  `docs/evidence/PHASE_R_GROUP_PRICE_EVIDENCE_2026-08-07.md`.
...
[`docs/evidence/PHASE_E_BOOKKEEPING_AND_ORDER_WAVE_EVIDENCE_2026-08-07.md`](PHASE_E_BOOKKEEPING_AND_ORDER_WAVE_EVIDENCE_2026-08-07.md).
...
[`docs/evidence/PHASE_N_CUSTOMER_INVOICE_SUMMARY_EVIDENCE_2026-08-07.md`](PHASE_N_CUSTOMER_INVOICE_SUMMARY_EVIDENCE_2026-08-07.md).
...
[`docs/evidence/PHASE_N_CUSTOMER_PROFIT_MARGIN_EVIDENCE_2026-08-07.md`](PHASE_N_CUSTOMER_PROFIT_MARGIN_EVIDENCE_2026-08-07.md).
...
open. See
[`docs/evidence/PHASE_O_PURCHASE_SUMMARY_EVIDENCE_2026-08-07.md`](PHASE_O_PURCHASE_SUMMARY_EVIDENCE_2026-08-07.md).
...
| Hardware | Software interfaces, deterministic ESC/POS renderers, desktop IPC, shared-secret handling, and no-adapter failures are tested. No physical device is connected in this evidence. | Pharmacy-device print/label byte or visual comparison, scanner-to-line-add timing, drawer pulse, biometric, SMS, and SMTP operator sign-off. See `docs/evidence/PHASE_U_HARDWARE_EVIDENCE.md`. |
| Scale and soak | Bounded probes are green at 25,000 stock rows / 10,000 GL journals. The full-volume disposable attempt failed during seeding when PostgreSQL terminated the connection; 3.2M stock rows, 1.04M GL rows, document-post latency, and the eight-hour soak remain unverified. | Re-run only on a provisioned disposable PostgreSQL instance with measured capacity, then execute the read-only soak. See `docs/evidence/PHASE_W_PERFORMANCE_EVIDENCE_2026-08-07.md`. |
...
recorded in docs/evidence/PHASE_Q_RECEIVABLES_AGING_EVIDENCE_2026-08-07.md. Historical
...
acceptance evidence in `docs/evidence/PHASE_K_PARTY_PAYMENT_EVIDENCE_2026-08-07.md`.
...
docs/evidence/PHASE_I_PURCHASE_CREDIT_TERMS_EVIDENCE_2026-08-07.md. Exact legacy batch
...
Focused evidence is recorded in
docs/evidence/PHASE_Q_ADVANCE_TAX_EVIDENCE_2026-08-07.md. Source import/count
...
See `docs/evidence/PHASE_E_MIGRATION_BOOKKEEPING_EVIDENCE_2026-08-07.md`.
...
operator acceptance remain open; see `docs/evidence/PHASE_U_HARDWARE_EVIDENCE.md`.
...
`docs/evidence/PHASE_I_PURCHASE_ITEM_POPULATION_EVIDENCE_2026-08-07.md`.
...
open. See `docs/evidence/PHASE_J_STOCK_EVIDENCE_2026-08-06.md`.
...
operator UAT remain open. See `docs/evidence/PHASE_F_ITEM_ALIAS_EVIDENCE_2026-08-07.md`.
...
operator UAT remain open. See `docs/evidence/PHASE_F_ITEM_IMAGE_EVIDENCE_2026-08-07.md`.
...
[`docs/evidence/PHASE_F_ITEM_NOTES_EVIDENCE_2026-08-07.md`](PHASE_F_ITEM_NOTES_EVIDENCE_2026-08-07.md).
...
[`docs/evidence/PHASE_F_ITEM_ASSOCIATIONS_EVIDENCE_2026-08-07.md`](PHASE_F_ITEM_ASSOCIATIONS_EVIDENCE_2026-08-07.md).
...
checks. See
[`docs/evidence/PHASE_F_ITEM_AUTHOR_EVIDENCE_2026-08-07.md`](PHASE_F_ITEM_AUTHOR_EVIDENCE_2026-08-07.md).
...
checks. See
[`docs/evidence/PHASE_F_ITEM_MODEL_EVIDENCE_2026-08-07.md`](PHASE_F_ITEM_MODEL_EVIDENCE_2026-08-07.md).
...
checks passed. See
[`docs/evidence/PHASE_F_ITEM_PRICE_POLICY_EVIDENCE_2026-08-07.md`](PHASE_F_ITEM_PRICE_POLICY_EVIDENCE_2026-08-07.md).
...
checks passed. See
[`docs/evidence/PHASE_F_ITEM_REGISTRATION_REQUEST_EVIDENCE_2026-08-07.md`](PHASE_F_ITEM_REGISTRATION_REQUEST_EVIDENCE_2026-08-07.md).
...
[`docs/evidence/PHASE_F_ITEM_POPULATE_EVIDENCE_2026-08-07.md`](PHASE_F_ITEM_POPULATE_EVIDENCE_2026-08-07.md).
...
in [`docs/evidence/PHASE_F_ITEM_UNPOSTED_TRANSACTIONS_EVIDENCE_2026-08-07.md`](PHASE_F_ITEM_UNPOSTED_TRANSACTIONS_EVIDENCE_2026-08-07.md).
...
verification described in `docs/archive/HANDOFF_2026-08-08.md` §2-3A, plus additional
