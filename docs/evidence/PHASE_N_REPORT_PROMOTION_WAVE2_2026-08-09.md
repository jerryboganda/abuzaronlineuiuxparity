...
`docs/evidence/PHASE_N_GOLDEN_VERIFICATION_SALE_RETURN_2026-08-09.md`, leaf 5):
...
(`docs/evidence/PHASE_N_GOLDEN_VERIFICATION_CATEGORY_B_2026-08-09.md`, leaf 3, its
...
- **`hourly-sales-graph`** — re-read wave-1's reasoning (top-level "graph"
  ...
  diagnostic doc (`docs/evidence/PHASE_N_GOLDEN_VERIFICATION_MISC_A_2026-08-09.md`)
