...
`category-wise-sales` in `docs/PHASE_N_REPORT_PROMOTION_2026-08-09.md`
...
`docs/PHASE_N_GOLDEN_VERIFICATION_SUMMARY_2026-08-09.md` (leaves 9-12): that
...
- **Diagnostic finding**: same category-name unblock as leaf 2 applies
  ...
  `docs/PHASE_N_GOLDEN_VERIFICATION_SUMMARY_2026-08-09.md` leaves 9/10), the
...
- `go test -run 'TestPhaseNReportRegistryDefinitionsAndAggregateFilters'
  ...
  in `docs/PHASE_N_REPORT_PROMOTION_2026-08-09.md`.
