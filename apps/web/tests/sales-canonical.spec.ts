...
test('cash sale sends canonical item, godown, pricing, lifecycle, and idempotency fields', async ({ page }) => {
  ...
  await page.route('**/v1/inventory/availability*', (route) => route.fulfill({ status: 200, contentType: 'application/json', body: JSON.stringify({ tenantId: 'tenant-1', branchId: 'branch-1', itemLegacyId: 'ITEM-1', godownId, batches: [{ batchId: '44444444-4444-4444-8444-444444444444', batchNumber: 'B-1', quantity: '5', unitCost: '1.00' }] }) }));
